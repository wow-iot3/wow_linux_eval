...
#define SHMCACHE_LOG_TAG "shmcache"
#define logEmerg(...)     ModuleEmergLog(SHMCACHE_LOG_TAG,__VA_ARGS__)
#define logCrit(...)      ModuleCritLog(SHMCACHE_LOG_TAG,__VA_ARGS__)
#define logAlert(...)     ModuleAlertLog(SHMCACHE_LOG_TAG,__VA_ARGS__)
#define logError(...)     ModuleErrorLog(SHMCACHE_LOG_TAG,__VA_ARGS__)
#define logWarning(...)   ModuleWarnLog(SHMCACHE_LOG_TAG,__VA_ARGS__)
#define logNotice(...)    ModuleNoticeLog(SHMCACHE_LOG_TAG,__VA_ARGS__)
#define logInfo(...)      ModuleInfoLog(SHMCACHE_LOG_TAG,__VA_ARGS__)
#define logDebug(...)     ModuleDebugLog(SHMCACHE_LOG_TAG,__VA_ARGS__) 
...
#define get_current_time_us() wow_time_get_usec()

#define MEM_ALIGN(x)  Align8(x)
